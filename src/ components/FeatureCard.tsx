...
const FeatureCard: React.FC<FeatureCardProps> = ({ image, title, description }) => {
  return (
    <div className="bg-white hover:bg-[#CFE8F4] relative w-[369px]  shadow-md shadow-black/10 rounded-[16px] p-[4px]  md:p-[20px] h-[290px] md:h-[431px] overflow-hidden">
      ...
      <div className="absolute -bottom-[30px] -left-[40px] w-[150px] h-[150px] rounded-full bg-gray-100/70 z-0 flex flex-row justify-center items-center">
        <div className="w-[80px] h-[80px] rounded-full bg-white hover:bg-[#CFE8F4]"></div>
      </div>
    </div>
  );
};
